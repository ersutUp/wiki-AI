...
def main():
    ...
    parser.add_argument(
        "input_path", type=str,
        help="Input PDF/image file path", default="/Users/ersut/my/tmp/dots.ocr-master/demo/demo_pdf1.pdf"
    )
    ...
    parser.add_argument(
        "--port", type=int, default=9180,
        help=""
    )
    parser.add_argument(
        "--model_name", type=str, default="dotsmorc:1.5",
        help=""
    )
    parser.add_argument(
